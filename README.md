...
- **Markdown Live Preview** — Obsidian-style editing: raw Markdown at the cursor, rendered everywhere else (Mermaid diagrams, tldraw drawings, collapsible `<details>` blocks)
...
- **Slash command** — Type `/` at line start to insert blocks (tldraw diagram, Mermaid diagram, table) via a command picker
